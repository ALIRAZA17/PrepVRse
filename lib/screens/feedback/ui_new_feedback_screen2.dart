...
class NewFeedBackScreen2 extends StatefulWidget {
  @override
  _NewFeedBackScreen2State createState() => _NewFeedBackScreen2State();
}

class _NewFeedBackScreen2State extends State<NewFeedBackScreen2> {
  bool isLoading = true;
